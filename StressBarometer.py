...
SIDEBAR_LOGO_HTML = (
    ...
    # Logo
    ".logo-img{width:80px;height:auto;margin-bottom:30px;filter:drop-shadow(0 0 10px rgba(255,255,255,0.2));}"
    
    # Kartica
    ".card{width:100%;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.1);border-radius:12px;padding:20px;box-sizing:border-box;}"
    ".label{font-size:0.7rem;font-weight:bold;display:flex;justify-content:space-between;margin-bottom:8px;text-transform:uppercase;letter-spacing:1px;}"
    
    # Progress bari
    ".bar-bg{height:8px;background:rgba(255,255,255,0.1);border-radius:10px;margin-bottom:20px;overflow:hidden;}"
    ".bar-stress{height:100%;width:82%;background:#ff4b4b;box-shadow:0 0 12px #ff4b4b;}"
    ".bar-energy{height:100%;width:28%;background:#00d2ff;box-shadow:0 0 12px #00d2ff;}"
    
    # Analitika
    ".infobox{margin-top:10px;padding-top:15px;border-top:1px solid rgba(255,255,255,0.1);}"
    ".formula{font-size:1.3rem;font-weight:bold;color:#ff4b4b;margin-bottom:5px;}"
    ".note{font-size:0.65rem;color:#94a3b8;line-height:1.4;}"
    "</style></head><body>"
    "<div class='wrapper'>"
        # Udaren bel logo
        ...
        # Dashboard
        "<div class='card'>"
            "<div class='label'><span>Stress Power</span><span>HIGH</span></div>"
            "<div class='bar-bg'><div class='bar-stress'></div></div>"
            
            "<div class='label'><span>Energy Level</span><span>CRITICAL</span></div>"
            "<div class='bar-bg'><div class='bar-energy'></div></div>"
            
            "<div class='infobox'>"
                "<div class='formula'>&sigma; &uarr; &rArr; W<sub>EU</sub> &darr;</div>"
                "<div class='note'>Higher stress intensity causes an immediate drain in energy efficiency (kcal).</div>"
            "</div>"
        "</div>"
    "</div></body></html>"
)
