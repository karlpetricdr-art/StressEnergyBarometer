...
# ============================================================
# 2b. SIDEBAR LOGO & ANALYTICS INFOGRAPHIC (English version)
# ============================================================
...
SIDEBAR_LOGO_HTML = (
    ...
    # Udaren Logo Badge
    ".logo-badge{position:relative;background:linear-gradient(145deg,#ffffff 0%,#f1f5f9 100%);"
    "border-radius:22px;padding:10px;box-shadow:0 10px 20px rgba(0,0,0,0.3);margin-bottom:25px;"
    "border:1px solid rgba(255,255,255,0.5);transition: transform 0.3s ease;}"
    ".logo-badge img{display:block;width:115px;height:auto;border-radius:12px;}"
    
    # Infografika - Kartica
    ".info-card{width:100%;background:rgba(255,255,255,0.06);border-radius:18px;padding:18px;"
    "border:1px solid rgba(255,255,255,0.1);box-sizing:border-box;}"
    ".info-header{font-size:0.8rem;font-weight:800;text-transform:uppercase;color:#4ade80;"
    "letter-spacing:1.2px;margin-bottom:15px;text-align:center;border-bottom:1px solid rgba(74,222,128,0.2);padding-bottom:8px;}"
    
    # Metrike
    ".metric-box{margin-bottom:14px;}"
    ".metric-label{display:flex;justify-content:space-between;font-size:0.65rem;font-weight:700;margin-bottom:5px;opacity:0.9;}"
    ".progress-bg{height:8px;background:rgba(0,0,0,0.4);border-radius:10px;overflow:hidden;position:relative;}"
    ".bar-stress{height:100%;background:linear-gradient(90deg,#ef4444,#dc2626);border-radius:10px;box-shadow:0 0 10px rgba(220,38,38,0.5);}"
    ".bar-energy{height:100%;background:linear-gradient(90deg,#3b82f6,#2563eb);border-radius:10px;box-shadow:0 0 10px rgba(37,99,235,0.5);}"
    
    # Razlaga korelacije
    ".impact-zone{margin-top:12px;padding:10px;background:rgba(239,68,68,0.12);border-radius:10px;text-align:center;border:1px dashed rgba(239,68,68,0.3);}"
    ".impact-title{font-size:0.75rem;font-weight:800;color:#fca5a5;margin-bottom:2px;}"
    ".impact-desc{font-size:0.65rem;color:#cbd5e1;line-height:1.3;font-style:italic;}"
    
    ".footer-tag{font-size:0.55rem;opacity:0.4;margin-top:12px;text-align:center;text-transform:uppercase;}"
    "</style></head><body>"
    "<div class='sidebar-wrapper'>"
        ...
        # Angleška Infografika o mehaniki sistema
        "<div class='info-card'>"
            "<div class='info-header'>System Dynamics</div>"
            
            # Stress Intensity Bar
            "<div class='metric-box'>"
                "<div class='metric-label'><span>STRESS INTENSITY (σ)</span><span>CRITICAL</span></div>"
                "<div class='progress-bg'><div class='bar-stress' style='width:78%'></div></div>"
            "</div>"
            
            # Energy Bar
            "<div class='metric-box'>"
                "<div class='metric-label'><span>USEFUL ENERGY (W_EU)</span><span>DRAINING</span></div>"
                "<div class='progress-bg'><div class='bar-energy' style='width:35%'></div></div>"
            "</div>"
            
            # Key takeaway
            "<div class='impact-zone'>"
                "<div class='impact-title'>KCAL DRAIN ALERT</div>"
                "<div class='impact-desc'>High stress intensity (σ) leads to exponential loss in energy efficiency.</div>"
            "</div>"
            
            "<div class='footer-tag'>Petrič Stress Barometer Engine</div>"
        "</div>"
    "</div>"
    "</body></html>"
)
